...
class Mixture(GenericPhase):
    r"""
    Creates Phase object that represents a mixture consisting of a given list
    of OpenPNM Phase objects.

    Mixture object assume a continuous composition of its constituent phases at each
    pore, whereas in the Multiphase object each pore can only take up one phase.
